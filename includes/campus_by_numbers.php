    ...
    <div class="row text-white ">
        <div class="col-6  col-md-4  col-lg-3 p-4">
            <div class="d-flex flex-row">
                <i class="fa fa-university icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">2,200</h1>
...
<!--
        <div class="col-6  col-md-4  col-lg-3 p-4">
           <div class="d-flex flex-row">
                <i class="fa fa-users icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">80</h1>
...
-->
        <div class="col-6  col-md-4  col-lg-3 p-4">
            <div class="d-flex flex-row">
                <i class="fa fa-book icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">546</h1>
        ...
        <div class="col-6  col-md-4  col-lg-3 p-4">
            <div class="d-flex flex-row">
                <i class="fa fa-database icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">634</h1>
...
-->
        <div class="col-6  col-md-4  col-lg-3 p-4">
            <div class="d-flex flex-row">
            <i class="fa fa-wrench icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">324</h1>
...
<!--
        <div class="col-6  col-md-4  col-lg-3 p-4">
           <div class="d-flex flex-row">
                <i class="fa fa-cog icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">53</h1>
        ...
        <div class="col-6  col-md-4  col-lg-3 p-4">
            <div class="d-flex flex-row">
               <i class="fa fa-graduation-cap icon fa-lg pt-4 pr-3 d-none d-sm-block" aria-hidden="true"></i>
                <div class="d-flex flex-column">
                    <h1 style="font-weight:bold;">60</h1>
