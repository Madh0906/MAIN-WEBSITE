    ...
    <div class="row">
        ...
        <div class="col-lg-4  ad border">
            ...
            <div class="card mt-2">
                <div class="row no-gutters">
                    <div class="col-2">
                        <img src="images/1.jpg" class="card-img small-card w-90  h-65 rounded" alt="...">
                    </div>
                    <div class="col-9">
                        <div class="card-body p-2 ml-3">
                            <span style="font-weight: bold; font-size: 18px;">Vice Chancellor</span><br>
                            <span style="font-size: 14px;">Prof.K Hemachandra Reddy</span><br>
                            <div class="text-right">
            ...
            <div class="card mt-2">
                <div class="row no-gutters">
                    <div class="col-2">
                        <img src="images/jayaramdir.jpg" class="card-img small-card w-90 h-65 rounded" alt="...">
                    </div>
                    <div class="col-9">
                        <div class="card-body p-2 ml-3">
                            <span style="font-weight: bold; font-size: 18px;">Director</span><br>
                            <span style="font-size: 14px;">Prof.B.Jayarami Reddy</span><br>
                            <div class="text-right">
                                    ...
                                    <div class="tab-pane fade show  " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <div class="news-box">
                                            ...
                                            <a href="pdfs/tenders/Telugu Webinar 01-10-2020.pdf" target="_blank">
                                                ...
                                                Circular to the Students and Staff 09-04-2021<font color="brown"><img src="img/new.gif"></font>
                                            </a>
                                        </div>
                                        <div class="news-box">
...
-->
                                         <div class="sall">
                                        <a class="d-block" href="../ver_new/instituteinfo.php?data=news_updates">Show all</a>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <div class="news-box">
                                            ...
                                            <a href="pdfs/tenders/Tally software 23-12-2020.pdf" target="_blank">
                                                <span>Open Competitive Bid (OCB) E-Procurement for Selection of Service provider for providing Security Services at RGUKT-Ongole campus (31-05-2020)</span><font color="brown"><img src="img/new.gif"></font>
                                            </a>
                                        </div>
                                        <div class="news-box">
                                            <i class="fa fa-hand-o-right news-box-icon fa-lg" aria-hidden="true" ></i>
                                       ...
                                       <div class="news-box">
                                            <i class="fa fa-hand-o-right news-box-icon fa-lg" aria-hidden="true" ></i>
                                            <a href="pdfs/tenders/Tally software 23-12-2020.pdf" target="_blank">
                                                <span>Sealed quotations are hereby invited from the registered firms/suppliers for Ceiling Fans for RGUKT-AP, Ongole Campus, BesideSanghamitra Hospital,Near South Bypass NH-5, Ongole, Prakasam District   (23-03-2021)</span><font color="brown"><img src="img/new.gif"></font>
                                            </a>
                                        </div>
                                                                                <div class="news-box">
                                             <i class="fa fa-hand-o-right news-box-icon fa-lg" aria-hidden="true" ></i>
                                            <a href="pdfs/tenders/Plumbing Items 20-23-12-2020.pdf" target="_blank">
                                                Sealed quotations from the registered firms/suppliers for Pen Tablet without display for Rajiv Gandhi University of Knowledge Technologies - A.P, Ongole Campus &nbsp;&nbsp;<span class="date">(23-03-2021)</span><font color="brown"><img src="img/new.gif"></font>
                                            </a>
                                        </div>
...
-->
                                        <div class="sall">
                                        <a class="d-block" href="../ver_new/instituteinfo.php?data=tenders">Show all</a>
                                    </div>
                                    </div>
