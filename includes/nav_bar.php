...
<nav class="navbar navbar-expand-lg navbar-dark main_navbar">
    <a class="navbar-brand text-light" href="#" style="font-size:16px;">RGUKT</a>
        ...
        <ul class="navbar-nav ml-auto navbar text-white" style="font-size:14px;">
            ...
            <li class="nav-item nav-item-back dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="#">Right to information act</a>
            ...
            <li class="nav-item nav-item-back dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a href="instituteinfo.php?data=COE" class="dropdown-item">Controller of Examination</a>
            ...
            <li class="nav-item nav-item-back dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a href="instituteinfo.php?data=DA" class="dropdown-item">Dean of academics</a>
                    ...
                    <a href="instituteinfo.php?data=AcademicRegulations" class="dropdown-item">Acedemic regulations</a>
            ...
            <li class="nav-item nav-item-back dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a href="../../new%20website/Nexus/index.php" target="_blank" class="dropdown-item">Student Cell</a>

                    <a href="../../new%20website/CDPC/home.php" class="dropdown-item" target="_blank">Placement Cell</a>


                    <a href="#" class="dropdown-item">Alumni Cell</a>
